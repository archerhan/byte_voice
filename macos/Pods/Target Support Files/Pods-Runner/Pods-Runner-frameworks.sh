...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../Flutter/ephemeral/.symlinks/plugins/sherpa_onnx_macos/macos/libonnxruntime.1.24.4.dylib"
  install_framework "${PODS_ROOT}/../Flutter/ephemeral/.symlinks/plugins/sherpa_onnx_macos/macos/libsherpa-onnx-c-api.dylib"
  install_framework "${PODS_ROOT}/../Flutter/ephemeral/.symlinks/plugins/sherpa_onnx_macos/macos/libsherpa-onnx-cxx-api.dylib"
fi
